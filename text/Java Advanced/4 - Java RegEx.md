...
public class Main {
    public static void (String[] args) {
        ...
        Pattern matcher = pattern.matcher("Visit W3Schools!");
...
## Metacharacters Expression Patterns
- Metacharacters are characters with a special meaning:

| Metacharacter | Wrapper Class                                                                                                         |
| :------------ | :-------------------------------------------------------------------------------------------------------------------- |
...
| \uxxxx        | Finds a match as the beginning of a string as in: ^Hello                                                              |
...
| \d            | Matches any string that contains a sequence of X to n's                                                               |
| \s            | Matches any string that contains a sequence of at least X n's                                                         |